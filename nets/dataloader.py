...
def load_dataset(args):
    ...
    train_sampler = FewShotSampler(trainset_labels, args.train_num_ways, args.num_shots, args.num_queries, args.episodes)
    test_sampler = FewShotSampler(testset_labels, args.test_num_ways, args.num_shots, 15, 600)
    val_sampler = FewShotSampler(valset_labels, args.test_num_ways, args.num_shots, 15, 100)
